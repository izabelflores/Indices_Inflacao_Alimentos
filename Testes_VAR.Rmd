...
granger1$Granger  # petroleo causa granger

granger2 <- causality(estim, cause = "IPCA")   

granger2$Granger  # IPCA não causa granger

granger3 <- causality(estim, cause = "Internacional")  # preço internacional causa granger a 5% de significância 

granger3$Granger

granger4 <- causality(estim, cause = "Assistência")  # Assistência não causa 

granger4$Granger

granger5 <- causality(estim, cause = "Câmbio")  # Câmbio não causa 

granger5$Granger

granger6 <- causality(estim, cause = "IBC")

granger6$Granger  # IBC  causa granger
